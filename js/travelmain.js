...
d3.json("data/Travel-Spending.json").then(jsonData => {
	...
	TravelareaChart = new TravelstackedAreaChart("travel-stacked-area-chart", Traveldata.layers);
	Traveltimeline = new TravelTimeline("travel-timeline", Traveldata.years);
