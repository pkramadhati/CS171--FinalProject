...
/*
 * TravelSpendingstackedAreaChart - ES6 Class
...
class TravelSpendingstackedAreaChart {

	// constructor method to initialize TravelSpendingstackedAreaChart object
	constructor(parentElement, data) {
		...
		let covidcolorarray=this.dataCategories.map( (d,i) => {
			return covidcolors[i%10]
		})
		...
		this.covidcolorScale = d3.scaleOrdinal()
			.domain(this.dataCategories)
			.range(covidcolorarray);
	}
